...
export interface ApiUserResumesUserResumes extends Struct.CollectionTypeSchema {
  collectionName: 'user_resumes1';
  info: {
    description: '';
    displayName: 'user-resumes';
    pluralName: 'user-resumes1';
    singularName: 'user-resumes';
  };
  options: {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::user-resumes.user-resumes': ApiUserResumesUserResumes;
